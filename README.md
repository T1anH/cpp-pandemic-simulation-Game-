...
- This project prioritizes correctness and system behavior over visualization
- Designed as a learning-focused simulation rather than a production epidemiology model
